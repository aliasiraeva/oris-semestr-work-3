...
<div class="grid" id="adsGrid">
    ...
    <c:forEach var="announcement" items="${announcements}">
        <div class="card" onclick="window.location.href='announcement.html?id=${announcement.id}'">
            <img src="${announcement.imageUrl}" alt="${announcement.title}">
            <div class="info">
                <p class="title">${announcement.title}</p>
                <p class="loc">${announcement.location}</p>
            </div>
        </div>
    </c:forEach>
</div>
...
<script>
    ...
    const announcements = [
        <c:forEach var="announcement" items="${announcements}">
        {id:${announcement.id},title:'${announcement.title}',category:'${announcement.category}',tags:['${announcement.tags}'],location:'${announcement.location}',imageUrl:'${announcement.imageUrl}'},
        </c:forEach>
    ];
